...
tela_label = Label(frame_tela, textvariable=visor, width = 15, height = 1, relief=FLAT, anchor='e', justify=RIGHT, font = fonte, bg="#292929", fg="#fafafa")
tela_label.place(x=6,y=8)
...
btb.place(x=x*3,y=0)
#Segunda Fileira
bt7 = Button(frame_botoes, command = lambda: entrada('7'), text="7", width=largura, height=altura, bg=cor1, font=font)
bt7.place(x=0,y=y)
bt8 = Button(frame_botoes, command = lambda: entrada('8'), text="8", width=largura, height=altura, bg=cor1, font=font)
bt8.place(x=x,y=y)
bt9 = Button(frame_botoes, command = lambda: entrada('9'), text="9", width=largura, height=altura, bg=cor1, font=font)
bt9.place(x=x*2,y=y)
bta = Button(frame_botoes, command = lambda: entrada('*'), text="*", width=largura, height=altura, bg=cor2, font=font)
bta.place(x=x*3,y=y)
#Terceita Fileira
bt4 = Button(frame_botoes, command = lambda: entrada('4'), text="4", width=largura, height=altura, bg=cor1, font=font)
bt4.place(x=0,y=y*2)
bt5 = Button(frame_botoes, command = lambda: entrada('5'), text="5", width=largura, height=altura, bg=cor1, font=font)
bt5.place(x=x,y=y*2)
bt6 = Button(frame_botoes, command = lambda: entrada('6'), text="6", width=largura, height=altura, bg=cor1, font=font)
...
#Quarta Fileira
bt1 = Button(frame_botoes, command = lambda: entrada('1'), text="1", width=largura, height=altura, bg=cor1, font=font)
bt1.place(x=0,y=y*3)
bt2 = Button(frame_botoes, command = lambda: entrada('2'), text="2", width=largura, height=altura, bg=cor1, font=font)
bt2.place(x=x,y=y*3)
bt3 = Button(frame_botoes, command = lambda: entrada('3'), text="3", width=largura, height=altura, bg=cor1, font=font)
...
#Quinta Fileira
bt0 = Button(frame_botoes, command = lambda: entrada('0'), text="0", width=11, height=altura, bg=cor1, font=font)
bt0.place(x=0,y=y*4)
btd = Button(frame_botoes, command = lambda: entrada('.'), text=".", width=largura, height=altura, bg=cor1, font=font)
